...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_SERVER['REQUEST_URI'] === '/paypal-api/checkout/orders/create-venmo') {
            ...
            'payment_source' => [
                'venmo' => [
                    'experience_context' => [
                        ...
                        'brand_name' => $input['brand_name'] ?? 'Your Store',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_SERVER['REQUEST_URI'] === '/paypal-api/checkout/orders/create-with-saved-venmo') {
    header('Content-Type: application/json');
